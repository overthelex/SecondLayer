...
- НІКОЛИ не згадуй технічні поля doc_id у відповіді. Посилайся на документи виключно за номером справи (case_number). Якщо справа має посилання (url), оформлюй його як markdown-посилання: [Номер справи](url). Якщо url відсутній — просто вказуй номер справи у жирному тексті.
