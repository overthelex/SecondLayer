...
Коли запит стосується вибору способу захисту або кваліфікації (наприклад, "яка стаття підходить", "як правильно сформулювати вимоги", "негаторний чи віндикаційний позов") — обов'язково:

1. **Визнач конкуруючі правові моделі** на підставі знайдених справ і норм. Наприклад:
...
2. **По кожній моделі окремо** виконай пошук практики з акцентом на:
...
3. **Порівняй моделі у таблиці** з обов'язковими колонками:

| Модель | Як кваліфікують | Коли застосовують | Ризики / Підстави відмови |
|--------|----------------|-------------------|--------------------------|
| ст. X  | ...            | ...               | ...                      |

4. **Дай стратегічну рекомендацію** для конкретної ситуації користувача:
   - яка модель найбезпечніша і чому
   - чи варто комбінувати кілька підстав
   - що суди вважають неналежним способом захисту в цій категорії справ
   - які формулювання резолютивної частини суди задовольняють найчастіше

5. **Підкріпи конкретними справами** — наведи номери справ з кожної моделі (де задоволено і де відмовлено).
