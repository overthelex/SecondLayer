...
### 3. Порівняй моделі у таблиці

ОБОВ'ЯЗКОВА таблиця з колонками:

| Підхід суду | Правова підстава | Коли застосовують | Як кваліфікують | Де відмовляють | Ризик для позивача |
|-------------|-----------------|-------------------|-----------------|----------------|-------------------|
...
### 4. Аналіз відмінностей юрисдикцій

Якщо серед знайдених справ є рішення різних юрисдикцій (КГС — Касаційний господарський суд, КЦС — Касаційний цивільний суд, адміністративні суди, апеляційні суди) — ОБОВ'ЯЗКОВО вкажи:
- чи відрізняється підхід господарських судів від цивільних у цій категорії справ
- чи різні вимоги до доказів у різних юрисдикціях
- чи різна формула резолютивної частини (наприклад, КГС частіше задовольняє "зобов'язати звільнити", а КЦС — "усунути перешкоди")
- наведи конкретні справи з кожної юрисдикції для порівняння
...
По кожному скасованому рішенню ОБОВ'ЯЗКОВО вкажи:
- номер справи та інстанція, що скасувала
- що вирішила перша інстанція
- чому скасували: неправильний спосіб захисту? недостатня конкретизація вимог? порушення прав третіх осіб? помилка у визначенні меж?
...
### 8. Аналіз виконуваності рішення
...
- чи передбачає практика право позивача виконати дії за відповідача (субсидіарне виконання: демонтаж/вивезення за рахунок відповідача) — наведи справи де суди це задовольняли або відмовляли
- як уникнути зависання виконавчого провадження: які формулювання резолютивної частини ДВС може реально виконати, а які — ні
- чи є практика стягнення витрат на примусове виконання з відповідача

Якщо формулювання вимоги не дозволяє примусове виконання (наприклад, занадто абстрактне) — прямо попередь про це і запропонуй альтернативне формулювання.

### 9. Стратегічна рекомендація
...
### 10. Підкріпи конкретними справами
