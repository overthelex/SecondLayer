...
export const SCENARIO_CATALOG: ScenarioCatalogEntry[] = [
...

  {
    ...
    responseTemplate: [
      ...
      { heading: 'Скасовані рішення', instruction: 'які рішення скасовані вищою інстанцією, чому, які висновки для адвоката', optional: true },
...

  {
    ...
    responseTemplate: [
      ...
      { heading: 'Скасовані рішення', instruction: 'які рішення скасовані, чому, висновки для адвоката', optional: true },
      { heading: 'Висновок', instruction: 'конкретна відповідь на запитання' },
      { heading: 'Стратегічна рекомендація', instruction: 'яка модель найбезпечніша, чеклист для позовної заяви', optional: true },
      { heading: 'Ризики', instruction: 'нюанси, застереження, ризики щодо третіх осіб' },
      { heading: 'Джерела', instruction: 'номери справ, статті законів' },
    ],
  },
