...
export const WORKFLOW_PRESET_LIST: WorkflowPresetMeta[] = [
  {
    ...
    description: 'Комплексний аналіз 273K+ судових рішень по військових злочинах з 24.02.2022. 5 workflows: статистика по ст. 407/408/402 КК, правові позиції Верховного Суду (касація), нормативна база (29 НПА включно зі Статутами ЗСУ, ЗУ «Про воєнний стан», КМУ щодо ТЦК/ВЛК/мобілізації), пом\'якшуючі обставини та угоди про визнання винуватості, розмежування адмін/кримінальної відповідальності за ухилення.',
    icon: 'shield',
    category: 'military',
    tags: ['кримінальне право', 'судова практика', 'законодавство', 'ВС', 'ТЦК'],
    stepsCount: 5,
  },
  {
    id: 'military_awol',
    title: 'Ст. 407 КК — Самовільне залишення частини',
    description: 'Глибокий аналіз 191K+ рішень по ст. 407 КК. 3 workflows: статистика по інстанціях (перша/апеляція/касація), типові покарання (реальне позбавлення волі vs випробувальний строк vs закриття провадження), нормативна база (ст. 407 КК + ст. 66 КК пом\'якшуючі + ст. 75 КК звільнення з випробуванням). Джерела: ЄДРСР + огляди ККС ВС.',
    icon: 'user-x',
    category: 'military',
    tags: ['кримінальне право', 'судова практика', 'ст. 407 КК'],
    stepsCount: 3,
  },
  {
    id: 'military_draft_evasion',
    title: 'Ухилення від мобілізації',
    description: 'Аналіз 26K+ рішень щодо ухилення від призову. 3 workflows: розподіл адмін (КУпАП ст. 210/210-1) vs кримінальна відповідальність, нормативна база (ЗУ «Про мобілізацію», КМУ №560, підстави відстрочки — ст. 23), успішні кейси захисту (закриття справ, неналежне повідомлення ТЦК, порушення процедури вручення повістки). Джерела: ЄДРСР + огляди КАС ВС.',
    icon: 'shield-alert',
    category: 'military',
    tags: ['адмінправо', 'кримінальне право', 'ТЦК', 'мобілізація'],
    stepsCount: 3,
  },
];
        ...
        steps: [
          {
            ...
            params: { query: 'КК ст. 407' },
            purpose: 'Ст. 407 КК — Самовільне залишення частини',
          },
          {
            id: 2,
            tool: 'get_legislation_section',
            params: { query: 'КК ст. 408' },
            purpose: 'Ст. 408 КК — Дезертирство',
          },
          {
            id: 3,
            tool: 'get_legislation_section',
            params: { query: 'ст. 1 Закону про воєнний стан' },
            purpose: 'ЗУ Про воєнний стан — визначення',
          },
          {
            id: 4,
            tool: 'get_legislation_section',
            params: { query: 'ст. 12 Закону про мобілізацію' },
        ...
        steps: [
          {
            id: 1,
            tool: 'get_legislation_section',
            params: { query: 'ст. 1 Закону про мобілізацію' },
          ...
          },
          {
            id: 3,
            tool: 'get_legislation_section',
            params: { query: 'ст. 23 Закону про мобілізацію' },
