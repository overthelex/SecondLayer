...
const LAWS_TO_SYNC = [
  ...
  '2755-17',         // КАСУ (Код. адміністративного судочинства)
  '1023-12',         // КЗПП (Кодекс законів про працю)

  // Additional major laws
  '2768-14',         // Податковий кодекс
  '2755-06',         // Бюджетний кодекс
  '2341-06',         // Митний кодекс
  '2095-19',         // Земельний кодекс
  '2768-03',         // Водний кодекс
  '3852-12',         // Лісовий кодекс
  '2661-06',         // Кодекс адміністративного судочинства (ГПКУ)
  '1798-12',         // Повітряний кодекс
