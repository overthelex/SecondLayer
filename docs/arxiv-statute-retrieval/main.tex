...
Ovcharov~\citep{ovcharov2025tokenizer} evaluates foundation model performance on Ukrainian legal text, finding that tokenizer fertility strongly predicts zero-shot accuracy.
