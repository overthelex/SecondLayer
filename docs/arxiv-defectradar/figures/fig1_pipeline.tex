...
% Input
\node[input] (corpus) {Legislative Corpus\\44{,}021 acts};
...
% Outputs
\node[output, below=1.2cm of s1] (defs) {5{,}799 definitions\\from 879 laws};
\node[output, below=1.2cm of s2] (circ) {1{,}880 \emph{circulus}\\defects (32.4\%)};
\node[output, below=1.2cm of s3] (igno) {1{,}885 \emph{ignotum}\\gaps (32.5\%)};
