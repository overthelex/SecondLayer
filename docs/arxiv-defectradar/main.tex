...
We evaluate GPT-4o as a zero-shot baseline, prompting it with the definition text and asking it to identify whether the definition exhibits (a)~\emph{circulus in definiendo} or (b)~\emph{ignotum per ignotum}, with chain-of-thought reasoning.
This baseline tests whether general-purpose language understanding suffices for the task.
...
Among the 312 \emph{circulus} definitions, we identify three structural subtypes:
