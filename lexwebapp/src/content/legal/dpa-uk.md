...
3.1. Предмет: обробка Даних Клієнта з метою надання послуг AI-аналізу юридичних документів, семантичного пошуку, зберігання документів та пов'язаних функцій Сервісу.
