...
2.5. У контексті Маркетплейсу юридичних консультацій Компанія виступає як Обробник даних Клієнта при забезпеченні технічної інфраструктури та як самостійний Контролер при обробці даних для цілей ескроу-розрахунків, верифікації Адвокатів, модерації та вирішення спорів.
...
- обробка регулюється DPA між Компанією та AWS;
...
- Адвокати є самостійними контролерами даних, отриманих у ході Консультацій, а не субобробниками Компанії;
- Компанія передає дані Замовника Адвокату виключно за явною згодою Замовника та в обсязі, визначеному Замовником;
...
- зміст Консультацій, проведених через захищені канали (відео, аудіо), захищений адвокатською таємницею — персонал Компанії не має до нього доступу.
