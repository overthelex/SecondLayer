...
Сервіс LEX AI, включаючи програмний код, дизайн, алгоритми та документацію, є інтелектуальною власністю Компанії та захищений законодавством про авторське право.
...
Сервіс надається «як є» (as is). Компанія не гарантує безперебійну роботу Сервісу та не несе відповідальності за:
