...
export function UKDataSourcesPage() {
  useDocumentMeta({
    title: 'UK Legal Open Data Sources | LEX',
    description: 'Curated directory of free and open data sources for UK courts, legislation, case law, business registries, and public records.',
    ogTitle: 'UK Legal Open Data Sources',
    ogDescription: 'Curated directory of free UK legal open data sources — courts, legislation, and public records.',
  });
