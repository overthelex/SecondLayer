...
Мы оценили семь foundation models от пяти провайдеров на украинском юридическом тексте, измеряя tokenizer fertility и downstream zero-shot performance на трёх задачах: классификация типа дела (4 класса), классификация результата рассмотрения (5 классов) и извлечение правовых норм (F1). Корпус оценки — 300 судебных решений из Единого государственного реестра судебных решений (ЕГРСР), стратифицированных по четырём юрисдикционным категориям.
...
14 из 21 комбинации модель-задача показывают деградацию при few-shot prompting. Особенно тяжёлый эффект для классификации результата рассмотрения: Qwen 3 235B теряет 27.3 процентных пункта, Nemotron Super 3 — 15.7 п.п.
