...
На 10% (3.37M документів) ми витратили **467 доларів** і 14.8 години роботи пайплайна. Залишилося ще 30.33M документів — це приблизно **3,100 доларів** і **130 годин** (близько 5.4 діб безперервного прогону). Сумарна вартість повної векторизації ЦПК-когорти — близько **3,600 доларів**.
...
- ~3,600 доларів сумарна вартість повної векторизації ЦПК
