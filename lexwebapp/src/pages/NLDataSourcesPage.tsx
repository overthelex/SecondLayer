...
export function NLDataSourcesPage() {
  useDocumentMeta({
    title: 'Netherlands Legal Open Data Sources | LEX',
    description: 'Curated directory of free and open data sources for Dutch courts, legislation, business registries, and public records.',
    ogTitle: 'Netherlands Legal Open Data Sources',
    ogDescription: 'Curated directory of free Dutch legal open data sources — courts, legislation, and public records.',
  });
