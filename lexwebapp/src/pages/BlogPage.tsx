...
Повний цикл — від "мені потрібен адвокат" до оплаченої консультації з відгуком. Без дзвінків, без email, без узгодження вручну.`,
  },
  {
    ...
    punchline: 'Один токен. Одна команда. 45 юридичних AI-інструментів прямо в Claude Desktop. Пошук судової практики, аналіз законодавства, перевірка контрагентів — без відкриття браузера. Створіть токен у профілі, вставте команду в термінал, і LEX AI стає розширенням вашого робочого столу.',
    category: 'legal',
...
*Один токен. Одна команда. 45 юридичних інструментів у вашому робочому столі.*
...
Це означає: ви можете підключити LEX AI як розширення до Claude Desktop і отримати доступ до 45 юридичних інструментів прямо в чаті з Claude.

## Що ви отримуєте

45 інструментів через один токен:
...
Claude побачить 45 доступних інструментів, обере потрібні, виконає пошук і видасть структуровану відповідь — з номерами справ, датами, судами, статусами прецедентів.
...
Один токен. 45 інструментів. Юридичний AI — там, де ви працюєте.`,
  },
  {
    id: 'data-privacy-ai',
