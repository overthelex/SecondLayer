...
export function DEDataSourcesPage() {
  useDocumentMeta({
    title: 'German Legal Open Data Sources | LEX',
    description: 'Curated directory of free and open data sources for German courts, legislation, regulations, business registries, and patents.',
    ogTitle: 'German Legal Open Data Sources',
    ogDescription: 'Curated directory of free German legal open data sources — courts, legislation, and regulations.',
  });
