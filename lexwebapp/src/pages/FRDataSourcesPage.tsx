...
export function FRDataSourcesPage() {
  useDocumentMeta({
    title: 'French Legal Open Data Sources | LEX',
    description: 'Curated directory of free and open data sources for French courts, legislation, regulations, business registries, and patents.',
    ogTitle: 'French Legal Open Data Sources',
    ogDescription: 'Curated directory of free French legal open data sources — courts, legislation, and regulations.',
  });
