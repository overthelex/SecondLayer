...
export const loginTranslations: Record<Locale, Record<string, string>> = {
  uk: {
    ...
    // OAuth
    googleAuth: 'Google',
    webviewGoogleWarning: 'Google не дозволяє вхід із вбудованого браузера.',
    webviewCopyLink: 'Скопіювати посилання',
    webviewLinkCopied: 'Посилання скопійовано — вставте у Safari або Chrome',
  ...
  en: {
    ...
    googleAuth: 'Google',
    webviewGoogleWarning: 'Google does not allow sign-in from in-app browsers.',
    webviewCopyLink: 'Copy link',
    webviewLinkCopied: 'Link copied — paste in Safari or Chrome',
  ...
  de: {
    ...
    googleAuth: 'Google',
    webviewGoogleWarning: 'Google erlaubt keine Anmeldung über In-App-Browser.',
    webviewCopyLink: 'Link kopieren',
    webviewLinkCopied: 'Link kopiert — in Safari oder Chrome einfügen',
  ...
  es: {
    ...
    googleAuth: 'Google',
    webviewGoogleWarning: 'Google no permite iniciar sesión desde navegadores integrados.',
    webviewCopyLink: 'Copiar enlace',
    webviewLinkCopied: 'Enlace copiado — pegar en Safari o Chrome',
