...
export const loginTranslations: Record<Locale, Record<string, string>> = {
  uk: {
    ...
    webviewOpenInBrowser: 'Відкрити у браузері',
  ...
  en: {
    ...
    webviewOpenInBrowser: 'Open in browser',
  ...
  de: {
    ...
    webviewOpenInBrowser: 'Im Browser öffnen',
  ...
  es: {
    ...
    webviewOpenInBrowser: 'Abrir en el navegador',
