  ...
  return (
    <div className="min-h-screen bg-sidebar-bg flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm text-center">
        ...
        <h1 className="text-xl font-bold text-txt-primary mb-1">SecondLayer Platform</h1>
        <p className="text-sm text-txt-muted mb-6">Developer Console</p>
        ...
        <p className="text-xs text-txt-muted mt-6">
