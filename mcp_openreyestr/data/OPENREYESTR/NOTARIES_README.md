# Реєстр Нотаріусів України (NAIS) -- Legacy

> **Увага:** Цей документ описує початковий імпорт нотаріусів.
> Актуальний імпорт -- через MCP-сервер: `npm run sync:registry -- --only=notaries`.
> Інструмент пошуку: `search_notaries`. Див. [/mcp_openreyestr/README.md](../../README.md).
